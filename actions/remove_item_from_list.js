...
fields: ["storage", "varName", "removeType", "position", "storage2", "varName2", "specItem"],
...
<div>
    <p>
        <u>Mod Info:</u><br>
        Created by DBM - Edited by Two<br><br>
    </p>
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		...
		<select id="removeType" class="round" onchange="glob.onChange1(this)">
			...
			<option value="3">Remove a Specific Item</option>
		</select>
		</div>
		<div id="specificItem" style="float: right; float: right; width: 50%; display: none;">
		Item Name:<br>
		<input id="specItem" class="round" type="text">
	</div>
	</div>
...
init: function() {
	...
	glob.onChange1 = function(event) {
		...
		const dom2 = document.getElementById('specificItem');
		if(value == 2) {
...
action: function(cache) {
	...
	switch(type) {
		...
		case 2:
			...
			break;
		case 3:
               list.splice( list.indexOf((this.evalMessage(variable, cache))), 1 );
			  result = list;
			break;
