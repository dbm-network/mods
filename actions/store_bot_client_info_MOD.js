module.exports = {
  ...
  subtitle (data) {
    const info = ['Uptime in Milliseconds', 'Ready At?', 'Ping', 'Guild Amount', 'User Amount', 'Rounded Ping', 'Uptime in Seconds', 'Uptime in Minutes', "Bots' Token", 'Voice Connections Amount', 'Total Amount of Channels', 'Total Amount of Emojis', 'This option has been removed', 'Uptime in Days', 'Uptime in Days (Rounded)', 'Memory (RAM) Usage', 'Bot Guilds Objects', 'Bot Guilds Names', 'Bot Guilds IDs', 'Bot Current Prefix', 'Bot Client ID', 'Discord JS Version', 'Uptime in Hours', 'Refreshing Uptime in Days', 'Refreshing Uptime in Hours', 'Refreshing Uptime in Minutes', 'Refreshing Uptime in Seconds', 'Memory (RAM) Usage in MB', "Bots' OS (Process Platform)", 'CPU Usage in MB', 'CPU Usage Average Percents', 'CPU Usage in Percent', "Bots' Directory", 'Node JS Version', 'Amount of Commands', 'Amount of Events', 'Ready At ? [timestamp]', 'CPU Core Count', 'Total Memory (GB)', 'Total Memory (MB)', 'Available Memory (GB)', 'Available Memory (MB)', 'Available Memory (%)', 'Used Memory (GB)', 'Used Memory (MB)', 'Used Memory (%)', 'Bot Owner ID', 'Are Commands Case Sensitive?', 'Last Message ID' ]
...
<div style="float: left; width: 80%; padding-top: 8px;">
  ...
  <select id="info" class="round">
    ...
    <optgroup label="System Measurements">
      ...
      <option value="47">Cpu Usage Average [1m, 5m, 15m] (%)</option>
