...
author: "DBM, Lasse, TheMonDon & Jasper",
...
variableStorage: function(data, varType) {
	...
	switch(info) {
		...
		case 19:
			dataType = "Message ID";
			break;
		case 20: // Added by Jasper in 1.9.6
			dataType = "Number";
			break;
	}
...
action: function(cache) {
	...
	switch(info) {
		...
		case 19:
			...
			break;
		case 20:
			result = server.members.get(mem.id).roles.size // Added by Jasper in 1.9.6
			break;
		default:
			break;
	}
