module.exports = {
  ...
  subtitle(data, presets) {
    return `Create backup of all giveaways`;
  },
...
This action is used to create a backup of a json file where all the information about each giveaway is saved, (this backup can be restored later using the "Giveaway Restore From Backup" action).
`;
  },
