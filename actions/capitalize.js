...
subtitle: function(data) {
	const info = ['Capitalize your letters', 'Capitalize your words']
...
short_description: "Capitalize your texts",
...
<select id="info" class="round">
	<option value="0" selected>Capitalize the first letter</option>
	<option value="1">Capitalize all words and letters</option>
</select>
</div><br>
<div style="padding-top: 8px;">
...
<div style="padding-top: 8px;">
		<p><u>Info:</u><br>
		<b>Capitalize first letter</b> just capitalizes the first words first letter!</p>
		</div>
	`
},
