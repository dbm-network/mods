module.exports = {
	...
	// Donation Link
	//
	// if you merge this with another you can remove  the below code
	// cause is not ethical to recive donation with other work =]]
	//
	//
	...
	action: function (cache) {
		...
		if(cmd == undefined || cmd == '') {return console.log('Please Command ID!')};
