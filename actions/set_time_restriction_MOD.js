module.exports = {
	...
	fields: ["value", "save", "iftrue", "iftrueVal", "iffalse", "iffalseVal", "storage", "varName"],
	...
	<div>
		<div id="modinfo">
			<p>
			Made by <b>${this.author}</b> and improved by <b>${this.helper}</b>.<br>
		...
		<div style="padding-top: 8px;">
			<div style="float: left; width: 39%;">
				Cooldown Time (ms):<br>
				<input id="value" class="round" type="text" placeholder="1000 ms = 1 second"><br>
			</div>
			<div style="padding-left: 1%; float: left; width: 55%;">
