module.exports = {
  ...
  subtitle(data, presets) {
    ...
    if (mode === 'giveawayById') {
      return `Delete a Giveaway by ID: ${data.giveawayIdInput || 'Unknown ID'}`;
    } else if (mode === 'all') {
      return `Delete All Giveaways`;
    }
    return `Delete a Giveaway (Var): ${data.varName || 'Unknown Variable'}`;
  },
  ...
  fields: ['storage', 'varName', 'giveawayId', 'giveawayIdInput'],
