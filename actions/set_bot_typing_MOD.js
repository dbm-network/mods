module.exports = {
  ...
  subtitle(data) {
    ...
    const index2 = parseInt(data.type, 10);
  ...
  action(cache) {
    ...
    try {
      // This "Try and Catch" Function is really useful for when it's coming up an error, it will log it in your logs.
      if (data.type === '0') {
        // "If and else" Function is for looking if the result of them equals what you wan't.
