module.exports = {
   ...
   //---------------------------------------------------------------------
	...
	//---------------------------------------------------------------------
		...
		author: "MrGold", //Idea by I Am Alien Pete & Original Code by NetLuis
	...
	action: function(cache) {
      const data = cache.actions[cache.index];
	   ...
	   const child = require('child_process');
	      try {
            child.execSync(command,{cwd: require('path').dirname(process.argv[1]),stdio:[0,1,2]})
