module.exports = {
  ...
  <div>
    ...
    <option value="assettocorsa">Assetto Corsa (2014)</option>
    <option value="atlas">Atlas (2018)</option>
    <option value="baldursgate">Baldur's Gate (1998)</option>
    <option value="barotrauma">Barotrauma (2019)</option>
    ...
    <option value="contagion">Contagion (2011)</option>
    ...
    <option value="daysofwar">Days of War (2017)</option>
    ...
    <option value="empyrion">Empyrion - Galactic Survival (2015)</option>
    ...
    <option value="jc3mp">Just Cause 3 - Multiplayer (2017)</option>
    ...
    <option value="minecraftping">Minecraft (2009)</option>
    <option value="minecraftpe">Minecraft</option>
    <option value="minecraftbe">Minecraft: Bedrock Edition (2011)</option>
    <option value="mnc">Monday Night Combat (2011)</option>
    <option value="mordhau">Mordhau (2019)</option>
    ...
    <option value="pixark">PixARK (2018)</option>
    <option value="ps">Post Scriptum</option>
    ...
    <option value="prbf2">Project Reality: Battlefield 2 (2005)</option>
    <option value="przomboid">Project Zomboid</option>
    <option value="quake1">Quake 1: QuakeWorld (1996)</option>
    <option value="quake2">Quake 2 (1997)</option>
    <option value="quake3">Quake 3: Arena (1999)</option>
    <option value="quake4">Quake 4 (2005)</option>
    <option value="quakelive">Quake Live (2010)</option>
    ...
    <option value="savage2">Savage 2: A Tortured Soul (2008)</option>
    ...
    <option value="swjk2">Star Wars Jedi Knight II: Jedi Outcast (2002)</option>
    <option value="swjk">Star Wars Jedi Knight: Jedi Academy (2003)</option>
    ...
    <option value="tshock">Terraria - TShock (2011)</option>
    <option value="forrest">The Forrest (2014)</option>
    ...
    <option value="valheim">Valheim (2021)</option>
