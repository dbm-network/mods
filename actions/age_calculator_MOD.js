  ...
  action(cache) {
    ...
    switch (INFO) {
      case 0:
        ...
        // INPUT: ['12', '23', '1990']
        converttoformat = `${dateArr[1]} ${monthsArr[parseInt(dateArr[0], 10) - 1]} ${dateArr[2]}`;
        converttodateformat = new Date(converttoformat);

        calcDOB = parseInt((new Date() - converttodateformat) / 60 / 60 / 24 / 365.242214 / 1000, 10); // Precise num of days in year, not 365 or 365.25
      ...
      case 1:
        ...
        // convert to DD/MM/YYYY so calc can work
        // INPUT: ['12', '23', '1990']
        converttoformat = `${dateArr[0]} ${monthsArr[parseInt(dateArr[1], 10) - 1]} ${dateArr[2]}`;
        converttodateformat = new Date(converttoformat);
      ...
      case 2:
        ...
        // convert to DD/MM/YYYY so calc can work
        // INPUT: ['12', '1990', '23']
        converttoformat = `${dateArr[2]} ${monthsArr[parseInt(dateArr[0], 10) - 1]} ${dateArr[1]}`;
        converttodateformat = new Date(converttoformat);
      ...
      case 3:
        ...
        // convert to DD/MM/YYYY so calc can work
        // INPUT: ['12', '1990', '23']
        converttoformat = `${dateArr[0]} ${monthsArr[parseInt(dateArr[2], 10) - 1]} ${dateArr[1]}`;
        converttodateformat = new Date(converttoformat);
      ...
      case 4:
        ...
        // convert to DD/MM/YYYY so calc can work
        // INPUT: ['1990', '12', '23']
        converttoformat = `${dateArr[2]} ${monthsArr[parseInt(dateArr[1], 10) - 1]} ${dateArr[0]}`;
        converttodateformat = new Date(converttoformat);
      ...
      case 5:
        ...
        // convert to DD/MM/YYYY so calc can work
        // INPUT: ['1990', '23', '12']
        converttoformat = `${dateArr[1]} ${monthsArr[parseInt(dateArr[2], 10) - 1]} ${dateArr[0]}`;
        converttodateformat = new Date(converttoformat);
