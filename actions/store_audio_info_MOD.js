  ...
  action(cache) {
    ...
    switch (info) {
      ...
      case 1:
        ...
        break;
      case 2:
        result = Audio.dispatchers[targetServer.id]?.startTime ?? 0; // when the music first started playing
        break;
      case 3:
      ...
      case 6:
        ...
        break;
      case 8:
        result = Audio.dispatchers[targetServer.id]?.player?.streamingData?.timestamp ?? 0; // seek position
        break;
      case 9:
