...
fields: ["username", "password", "mailto", "subject", "type", "text", "iffalse", "iffalseVal"],
...
<div style="width: 550px; height: 350px; overflow-y: scroll;">
    ...
    <div>
      ...
      - Html tags for the html format: <a href="https://www.w3schools.com/tags/">W3schools Html Reference</a>.<br>
    </div><br>
	...
	<div style="float: left; width: 50%;">
		Password:<br>
		<input id="password" class="round" type="text">
	</div><br><br><br>
	<div style="float: left; width: 50%;">
		mailto:<br>
...
//---------------------------------------------------------------------
  ...
  action: function(cache) {
    ...
    const WrexMODS = _this.getWrexMods();
		WrexMODS.CheckAndInstallNodeModule('nodemailer');
    
    //Big thank to W3schools.com for this code.
  	const nodemailer = WrexMODS.require('nodemailer');
