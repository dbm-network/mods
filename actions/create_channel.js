...
subtitle: function(data) {
	...
	short_description: "Creates text channel to specific server.",
...
fields: ["server", "channelName", "categoryID", "topic", "position", "storage", "varName",],
...
action: function(cache) {
	...
	const server = this.getServer(parseInt(data.server), varName, cache);
