module.exports = {
	...
	action: function(cache) {
		...
		const emo = custommethods.getEmoji(emoji, varName, cache); //Get Emoji
		if(!custommethods) console.log('Store Emoji Info ERROR: You need abb_custom_methods_MOD.js to use this modification'); //If abb_custom_methods_MOD.js file is missing -> Error
		if(custommethods.Version < "1.0.2") console.log('Store Emoji Info ERROR: Please update abb_custom_methods_MOD.js to 1.0.2 or newer to use this modification'); //If custommethods are too old -> Error
		if(!emo) {
